...
public class Potion_bouclier extends Item {

	public Potion_bouclier(int col, int row, Tile[][] mapTiles) {
		super(col,row,mapTiles);
	}

	public Potion_bouclier (Tile[][] mapTiles,float distance_min,Player p) {
	...
	protected void initSprites() {
		SpriteSheet Sprite = new SpriteSheet("res/Objects/Potion-bouclier.png",32,32);
