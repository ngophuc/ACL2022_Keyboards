...
public class Potion_vie extends Item {
	...
	public Potion_vie(int col, int row, Tile[][] mapTiles) {
	...
	public Potion_vie (Tile[][] mapTiles,float distance_min,Player p) {
	...
	protected void initSprites() {
		SpriteSheet Sprite = new SpriteSheet("res/Objects/Potion-vie.png",32,32);
