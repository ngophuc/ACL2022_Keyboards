...
public class Potion_vitesse extends Item {

	public Potion_vitesse(int col, int row, Tile[][] mapTiles) {
	...
	public Potion_vitesse (Tile[][] mapTiles,float distance_min,Player p) {
	...
	protected void initSprites() {
		SpriteSheet Sprite = new SpriteSheet("res/Objects/Potion-vitesse.png",32,32);
